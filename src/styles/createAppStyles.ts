...
export function createAppStyles(
  ...
  return StyleSheet.create({
    ...
    timelineStatusBadgeTaken: {
      position: 'absolute',
      top: 12,
      right: 12,
    },
    timelineStatusBadgeMissed: {
      position: 'absolute',
      top: 12,
      right: 12,
    },
